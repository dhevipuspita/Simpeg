                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="form-select" id="selectPegawai" onchange="fillPegawaiData()" {{ $dataInduk ?? '' ? 'disabled' : '' }}>
                                        <option value="">-- Pilih Pegawai dari Data Induk --</option>
                                        @php
                                        ...
                                        @foreach($allPegawai as $p)
                                            <option value="{{ $p->id }}" 
                                                ...
                                                {{ $p->nama }} - {{ $p->npa ?? 'Tanpa NPA' }} ({{ $p->status }})
                                            </option>
                                        @endforeach
                                    </select>
                                    <small class="text-muted">Pilih pegawai dari data induk untuk mengisi data otomatis</small>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="mulai_bertugas" id="mulai_bertugas" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="gol" id="gol" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ttl" placeholder="Jakarta, 01-01-1990">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="pendidikan" placeholder="S1">
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <hr>
                                    <h6 class="mb-3">Tanggal SK</h6>
                                </div>

                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Tanggal</label>
                                        <input type="number" class="form-control" name="tgl" placeholder="01" min="1" max="31">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="bln" placeholder="12" min="1" max="12">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="thn" placeholder="2024">
                                    </div>
                                </div>
